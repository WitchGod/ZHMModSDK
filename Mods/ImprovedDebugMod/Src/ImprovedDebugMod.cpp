...
ImprovedDebugMod::~ImprovedDebugMod()
{
    const ZMemberDelegate<ImprovedDebugMod, void(const SGameUpdateEvent&)> s_Delegate(this, &ImprovedDebugMod::OnFrameUpdate);
    Globals::GameLoopManager->UnregisterFrameUpdate(s_Delegate, 1, EUpdateMode::eUpdatePlayMode);
}

void ImprovedDebugMod::Init()
{
    Hooks::ZEntitySceneContext_ClearScene->AddDetour(this, &ImprovedDebugMod::OnClearScene);
}

void ImprovedDebugMod::OnEngineInitialized()
{
    const ZMemberDelegate<ImprovedDebugMod, void(const SGameUpdateEvent&)> s_Delegate(this, &ImprovedDebugMod::OnFrameUpdate);
...
void ImprovedDebugMod::OnFrameUpdate(const SGameUpdateEvent& p_UpdateEvent)
{

}

void ImprovedDebugMod::OnDrawMenu()
{
...
void ImprovedDebugMod::OnDrawUI(bool p_HasFocus)
{
    ImGuizmo::BeginFrame();
...
void ImprovedDebugMod::OnMouseDown(SVector2 p_Pos, bool p_FirstClick)
{
    SVector3 s_World;
...
void ImprovedDebugMod::DrawOptions(bool p_HasFocus)
{
...
void ImprovedDebugMod::EquipOutfit(
...
void ImprovedDebugMod::SpawnRepositoryProp(const ZRepositoryID& p_RepositoryId, const bool addToWorld)
{
...
void ImprovedDebugMod::SpawnNonRepositoryProp(const char* p_PropAssemblyPath)
{
    const auto s_Scene = Globals::Hitman5Module->m_pEntitySceneContext->m_pScene;
...
auto ImprovedDebugMod::SpawnNPC(
...
void ImprovedDebugMod::LoadRepositoryProps()
{
...
void ImprovedDebugMod::LoadHashMap()
{
    // TODO: Re-do.
...
void ImprovedDebugMod::DownloadHashMap()
{
...
std::string ImprovedDebugMod::GetEntityName(
...
std::string ImprovedDebugMod::FindNPCEntityNameInBrickBackReferences(
    unsigned long long p_TempBrickHash,
    unsigned long long p_EntityId,
    unsigned long long& p_ResourceHash
)
...
void ImprovedDebugMod::LoadResourceData(unsigned long long p_Hash, std::vector<char>& p_ResourceData)
{
    static std::string s_RpkgFilePath = GetPatchRPKGFilePath();
    LoadResourceData(p_Hash, p_ResourceData, s_RpkgFilePath);
}

void ImprovedDebugMod::LoadResourceData(unsigned long long p_Hash, std::vector<char>& p_ResourceData, const std::string& p_RpkgFilePath)
{
...
std::string ImprovedDebugMod::GetPatchRPKGFilePath()
{
...
unsigned long long ImprovedDebugMod::GetDDSTextureHash(const std::string p_Image)
{
...
void ImprovedDebugMod::TeleportSpatialEntityToMatrix(ZSpatialEntity* p_SpatialEntity, SMatrix p_TargetMatrix)
{
...
void ImprovedDebugMod::TeleportActorToHitman(ZActor* p_Actor)
{
    TEntityRef<ZHitman5> s_LocalHitman;
    Functions::ZPlayerRegistry_GetLocalPlayer->Call(Globals::PlayerRegistry, &s_LocalHitman);
...
void ImprovedDebugMod::SwapSpatialEntities(ZSpatialEntity* p_EntityA, ZSpatialEntity* p_EntityB)
{
...
void ImprovedDebugMod::SwapHitmanAndActor(ZActor* p_Actor)
{
    ...
    if (s_LocalHitman)
    {
        ...
        SwapSpatialEntities(s_ActorSpatialEntity, s_HitmanSpatialEntity);
    }
}
...
void ImprovedDebugMod::CopyToClipboard(const std::string& p_String) const
{
...
void ImprovedDebugMod::OnDraw3D(IRenderer* p_Renderer)
{
...
DEFINE_PLUGIN_DETOUR(ImprovedDebugMod, void, OnClearScene, ZEntitySceneContext* th, bool fullyClear)
{
    m_EntityMutex.lock();
...
DEFINE_ZHM_PLUGIN(ImprovedDebugMod);
