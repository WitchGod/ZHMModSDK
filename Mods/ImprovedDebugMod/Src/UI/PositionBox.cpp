...
void ImprovedDebugMod::DrawPositionBox(bool p_HasFocus)
{
    ...
    if (s_Showing)
    {
        ...
        if (ImGui::BeginTable("ImprovedDebugMod_HitmanPosition", 4))
        {
            for (int i = 0; i < 4; ++i)
            {
                ImGui::TableNextRow();
        ...
        if (ImGui::BeginTable("ImprovedDebugMod_Camera_Position", 4))
        {
            for (int i = 0; i < 4; ++i)
            {
                ImGui::TableNextRow();
