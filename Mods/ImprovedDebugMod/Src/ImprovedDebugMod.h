...
class ImprovedDebugMod : public IPluginInterface
{
public:
    ~ImprovedDebugMod() override;
...
private:
    ...
    DECLARE_PLUGIN_DETOUR(ImprovedDebugMod, void, OnClearScene, ZEntitySceneContext* th, bool fullyClear);
